...
def main(spec: RudderExperimentSpec) -> None:
    ...
    # Train LSTM
    rd.train_rudder(lstm, optimizer, epoches=10, data_loader=env_loader, show_gap=10, device=device,
    ...
    # Train LSTM
    rd.train_rudder(lstmcell, optimizer, epoches=10, data_loader=env_loader, show_gap=10, device=device,
                    show_plot=spec.show_plot)
